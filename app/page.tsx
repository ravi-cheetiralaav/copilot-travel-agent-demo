...
export default async function HomePage() {
  ...
  return (
    <div>
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-theme-primary-600 to-theme-primary-700 text-white theme-transition">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/trips">
                <Button size="lg" className="bg-white text-theme-primary-600 hover:bg-gray-100">
                  Explore Trips
                </Button>
              </Link>
              <Link href="/guides">
                <Button size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-theme-primary-600">
                  Travel Guides
                </Button>
              </Link>
            </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-theme-primary-100 rounded-full flex items-center justify-center mx-auto mb-4 theme-transition">
      ...
      {/* CTA Section */}
      <section className="py-16 bg-theme-primary-600 text-white theme-transition">
